...
data class CondicionMeteorologicaClase(val id:Int,var fecha:String, var niebla:Int, val agua: Int, var lluvia: Int,  val densidad:String, val idUsuario: Int, val idFranja: Int, val nombre: String) {
